...
// Browser and Node.js compatible WASM initialization (fork of @stephen-riley/pcre2-wasm)
!function() {
 // Set up WASM file locator for Node.js environments
 // In browsers, the environment detection below handles this via scriptDirectory
 if (typeof process === "object" && typeof process.versions === "object" && typeof process.versions.node === "string") {
  // Node.js environment - use dynamic import for path resolution
  try {
   var url = require("url");
   ...
   // Fallback: try using __dirname directly if available (CommonJS)
...
if (ENVIRONMENT_IS_NODE) {
 ...
 if (typeof module !== "undefined") {
  try { module["exports"] = Module; } catch (e) { /* ESM mode - ignore */ }
 }
...
var wasmBinaryFile = "libpcre2.wasm";
